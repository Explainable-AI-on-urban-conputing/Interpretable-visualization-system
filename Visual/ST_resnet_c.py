...
def forward_network(in_channels,nb_flow,map_height,map_width,nb_residual_unit):
    out_channels= 32
    return nn.Sequential(OrderedDict([
        ('conv',nn.Conv2d(in_channels, out_channels, kernel_size=5,stride=1, padding=1, bias= True)),
        ...
        ('relu', nn.ReLU()),
        ('conv1', nn.Conv2d(out_channels, out_channels, kernel_size=5, stride=1, padding=1, bias=True)),
        ('conv2', nn.Conv2d(out_channels, 2, kernel_size=5, stride=1, padding=1, bias=True)),
